...
export default class Equipment extends Component {
    ...
    render() {
        return (
            <div className="equipment_page select_page">
                <div className="wrap">
                    <div className="bread">
                        <a href="/"> Главная</a>
                        <span>Оборудование автомобилей такси</span>
                    </div>

                    <h1 className='zag'>Оборудование автомобилей такси</h1>
                    
                    <div className="equipment_wrap select_wrap">
